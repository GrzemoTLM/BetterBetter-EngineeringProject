...
def main() -> None:
    ...
    application.job_queue.run_repeating(check_budget_exceeded, interval=3600, first=10)
    application.job_queue.run_repeating(send_pending_reports, interval=60, first=3)
